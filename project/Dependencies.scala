...
object Dependencies {
  ...
  object amazonAws {
    val dynamodb = "com.amazonaws" % "aws-java-sdk-dynamodb" % "1.11.998"
    val s3       = "com.amazonaws" % "aws-java-sdk-s3"       % "1.11.998"
  }
  ...
  object mysql {
    val connectorJava = "mysql" % "mysql-connector-java" % "8.0.23"
  }
